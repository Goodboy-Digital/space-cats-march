...
export default class GameScreen extends Screen
{
    ...
    collectItem(item)
    {
        switch (item.itemType)
        {
            case 0:
                ...
                this.inGameEffects.popLabel(item, '+' + utils.formatPointsLabel(tempTrophy / MAX_NUMBER), 0, 3, 1);
                break;
            case 1:
                this.addAutoCollectMode();
                break;
            case 2:
                ...
                this.inGameEffects.popLabel(item, '+' + utils.formatPointsLabel(tempPoints), 0, 3, 1);
    ...
    missCat(cat)
    {
        ...
        if (cat.catData.isAuto || this.isAutoCollectMode)
        {
            cat.finishTimer = -999
